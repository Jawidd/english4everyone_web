...
export default function NewsPost() {
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
      <Link to="/news" className="inline-flex items-center gap-2 font-medium mb-8 transition-colors hover:opacity-80"
      ...
      <div className="prose-content"><ReactMarkdown>{post.body}</ReactMarkdown></div>
    </article>
  )
}
